...
from frameworks.keras.utils import DTYPE, finite_diff_grad_scalar, viz_stage
...
final_vanilla, hist_vanilla = gradient_descent_with_momentum(
    quadratic_bowl, np.array(10.0, dtype=np.float32), 0.05, 0.0, 50
)
final_momentum, hist_momentum = gradient_descent_with_momentum(
    quadratic_bowl, np.array(10.0, dtype=np.float32), 0.05, 0.9, 50
)
