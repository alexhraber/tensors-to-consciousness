# 1_automatic_differentiation.py (NumPy)
import numpy as np

from frameworks.numpy.utils import DTYPE, finite_diff_grad_scalar, finite_diff_grad_vector, viz_stage
...
point = np.array([0.0, 0.0], dtype=DTYPE)
